...
myLock :: String
myLock = "lxlock" -- Lock screen

myEmacs :: String
myEmacs = "nvim"  -- Makes emacs keybindings easier to type
...
myLayoutHook = avoidStruts $ mouseResize $ windowArrange $ T.toggleLayouts floats
             ...
             where
               myDefaultLayout =     withBorder myBorderWidth floats
                                 ||| noBorders tabs
                                 ||| grid
                                 ||| threeCol
                                 ||| threeRow
...
myKeys =
    ...
    -- KB_GROUP Window resizing
        , ("M4-h", sendMessage Shrink)                   -- Shrink horiz window width
        , ("M4-j", sendMessage MirrorShrink)          -- Shrink vert window width
        , ("M4-k", sendMessage MirrorExpand)          -- Expand vert window width
