...
# List of the themes
ZSH_THEME_RANDOM_CANDIDATES=( "robbyrussell" "agnoster" "af-magic" "afower" "alanpeabody" "amuse" "arrow" "aussiegeek" "avit" "awesomepanda" "bira" "blinks" "bureau" "candy" "clean" "cloud" "crunch" "cypher" "dallas" "darkblood" "daveverwer" "dieter" "dogenpunk" "dpoggi" "eastwood" "evan" "fishy")


# Allow command line auto-correction
ENABLE_CORRECTION="true"

# Custom plugins may be added to ~/.oh-my-zsh/custom/plugins/
# Example format: plugins=(rails git textmate ruby lighthouse)
# Add wisely, as too many plugins slow down shell startup.
plugins=(git extract web-search yum git-extras docker vagrant autojump zsh-autosuggestions zsh-syntax-highlighting pass zsh-completions)
plugins+=(git-flow git-extras git fzf vi-mode) 
...
# Show directory after "cd" command 
# exa command is modern version of ls with fancy colors.
# It uses colors to distinguish file types and metadata. It knows about symlinks, extended attributes, and Git. And
